//Renders MotionVectors Only. Derived from The Unlit shader so we just keep the unused properties to keep the Shader UI happy.
Shader "Hidden/MotionVectorOnly"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "ShaderPassMotionVectors.hlsl"
